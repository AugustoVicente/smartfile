...
<div class="container-fluid">
    ...
    ?>
    <script src="js/CadastroUsuarioLiderAltera.js"></script>
    <div class="row">
        <div class="white-box">
            <?php
                echo'<form class="form-horizontal form-material" onsubmit="return verifica()" method="POST" action="../../../webservice.php?web=true&acao=AlterarUsuarioLider&idUsuario='.$idUsuario.'">';
            ?>
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <input type="text"  value="Lider Operacional" readonly="readonly" class="form-control form-control-line" name="tipo">
                        </div>
                    </div>
                    <div class="row">
