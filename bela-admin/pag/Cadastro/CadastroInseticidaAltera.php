...
<div class="container-fluid">
    <?php
        $layout->titulo("Editar Inseticida");
        ...
        <div class="white-box">
            ...
            ?>
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <?php
                            echo '<input type="number" placeholder="Insira o código" value="'.$inseticida->codigo.'" id="codigo" class="form-control form-control-line" name="codigo">';
                        ?>
                    </div>
                </div>
                <div class="row">
