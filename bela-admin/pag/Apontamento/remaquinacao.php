...
<div class="container-fluid">
    <?php
        $layout->titulo("Remaquinação");
    ?>
    <script src="js/remaquinacao.js"></script>
    <div class="row">
        <div class="white-box">
                <?php
                    global $logado;
                    echo '<form class="form-horizontal form-material" onsubmit="return verifica()" method="POST" action="../../../webservice.php?web=true&acao=InserirRemaquinacao&login='.$logado.'">';
                ?>
