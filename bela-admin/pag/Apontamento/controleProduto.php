...
<div class="container-fluid">
    <?php
        $layout->titulo("Controle de safra");
                ...
                <div class='form-group white-box'> 
                    <div class='row'>
                        ...
                        <div class='col-sm-3' id='divBtn'>
                            <button class='btn btn-success' onsubmit='submitFim()' type='submit' value='Submit'>Confirmar fim de safra!</button>
                        </div>
                    </div>
                </div>
            </form>";
            ...
            echo "<form class='form-horizontal form-material' onsubmit='return submitInicio()' method='POST' action='../../../webservice.php?web=true&acao=NovoProduto&idSilo=".$idSilo."'>
                <div class='form-group white-box'> 
                    ...
                    <div class='col-sm-2' id='divBtn'>
                        <button class='btn btn-success' type='submit' value='Submit'>Confirmar início de safra!</button>
                    </div>
                </div>
            </form>";
        }
