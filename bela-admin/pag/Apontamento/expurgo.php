...
<div class="container-fluid">
    <?php
        $layout->titulo("Expurgos");
    ?>
    <script src="expurgo.js"></script>
    <div class="row">
        <div class="white-box">
            <?php
                global $logado;
                echo '<form class="form-horizontal form-material" onsubmit="return verifica()" method="POST" action="../../../webservice.php?web=true&acao=InserirExpurgo&login='.$logado.'">';
            ?>
                <div class="form-group white-box">
                    ...
                    <div class="row">
                        <label class="col-md-2">Nº do Receituário</label>
                        <div class="col-md-3">
                            <input type="number" placeholder="Insira o número" size="50px" class="form-control form-control-line" name="numReceituario" id="numReceituario">
                        </div>
                        <h3 class="col-md-1 text-center">|</h3>
                    </div>
                </div>
