...
<div class="container-fluid">
    <?php
        ...
        $turno          =$usuario->turno;
    ?>
    <script src="js/CadastroUsuarioOperadorAltera.js"></script>
    <div class="row">
        <div class="white-box">
            <?php
                echo'<form class="form-horizontal form-material" onsubmit="return verifica()" method="POST" action="../../../webservice.php?web=true&acao=AlterarUsuarioOperador&idUsuario='.$idUsuario.'">';
            ?>
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <input type="text"  value="Operador" readonly="readonly" class="form-control form-control-line" name="tipo">
                        </div>
                    </div>
                    <div class="row">
