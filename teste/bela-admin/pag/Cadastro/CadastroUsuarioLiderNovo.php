...
?>
<!-- Conteúdo -->
<script src="js/CadastroUsuarioLiderNovo.js"></script>
<div class="container-fluid">
    ...
    <div class="row">
        <div class="white-box">
            <form class="form-horizontal form-material" method="POST" onsubmit="return verifica()" action="../../../webservice.php?web=true&acao=InserirUsuarioLider">
                <div class="form-group">
                    ...
                    <label class="col-md-3">Tipo de usuário</label>
                        <div class="col-md-3">
                            <input type="text"  value="Lider Operacional" readonly="readonly" class="form-control form-control-line" name="tipo" id="tipo">
                        </div>
                </div>
                <div class="row">
