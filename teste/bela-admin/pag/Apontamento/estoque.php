...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="white-box">
            <?php
                global $logado;
                echo '<form class="form-horizontal form-material" onsubmit="return verifica()" method="POST" action="../../../webservice.php?web=true&acao=InserirEstoque&login='.$logado.'">';
            ?>
                <div class="form-group white-box">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <select class='form-control form-control-line' name='ocorrencia' id='ocorrencia'>
                                <option value='' disabled selected>Selecione</option>
                                <option value="Enchimento">Enchimento</option>
                                <option value="Esvaziamento">Esvaziamento</option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-md-2">Toneladas</label>
                        <div class="col-md-3">
                            <input type="number" placeholder="Coloque a quantidade em toneladas" size="50px" class="form-control form-control-line" min="0" name="Toneladas" id="Toneladas">
                        </div>
                        <h3 class="col-md-1 text-center">|</h3>
