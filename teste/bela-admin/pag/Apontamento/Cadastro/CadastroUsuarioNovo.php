...
?>
<!-- Conteúdo -->
<script type="text/javascript" src="js/CadastroUsuarioNovo.js"></script>
<div class="container-fluid">
    ...
    <div class="row">
        <div class="white-box">
            <form class="form-horizontal form-material" method="POST" onsubmit="return verifica()" action="../../../webservice.php?web=true&acao=InserirUsuario">
