...
function qtdTratado()
{
    ...
    else
    {
        ...
        {
            escolheInseticidaUm();
            escolheInseticidaDois();
        }
        else if(document.getElementById('tres').checked)
        {
            escolheInseticidaUm();
            escolheInseticidaDois();
            escolheInseticidaTres();
        }
    }
}
...
{ 
    if(document.getElementById("qtdToneladas").value != null && document.getElementById("qtdToneladas").value != ""
    && document.getElementById("inseticidaUm").value != "")
    {
        var toneladas = document.getElementById("qtdToneladas").value;
...
{
    if(document.getElementById("qtdToneladas").value != null && document.getElementById("qtdToneladas").value != ""
    && document.getElementById("inseticidaUm").value != "" && document.getElementById("inseticidaDois").value != "")
    {
        var toneladas = document.getElementById("qtdToneladas").value;
